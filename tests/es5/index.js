/* global HtmlFactory */
var { toFragment, toElementNs, toElement } = HtmlFactory;
...
result = toFragment(
	...
	function(element) { console.log('Document Fragment', element); }
);
...
result = toElementNs(
	...
	function(element) { console.log('SVG Element', element); }
);
...
result = toElement(
	...
	{ 'class': 'className' },
	['Hello', toElement('br'), 'World'],
	function(element) { void console.log('HTML Element', element); }
);
